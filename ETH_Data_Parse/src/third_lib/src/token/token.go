...
func (_Token *TokenCaller) FreezeOf(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "freezeOf", arg0)
...
//
// Solidity: function freezeOf(address ) returns(uint256)
func (_Token *TokenSession) FreezeOf(arg0 common.Address) (*big.Int, error) {
	return _Token.Contract.FreezeOf(&_Token.CallOpts, arg0)
}

// FreezeOf is a free data retrieval call binding the contract method 0xcd4217c1.
//
// Solidity: function freezeOf(address ) returns(uint256)
func (_Token *TokenCallerSession) FreezeOf(arg0 common.Address) (*big.Int, error) {
	return _Token.Contract.FreezeOf(&_Token.CallOpts, arg0)
}
...
func (_Token *TokenTransactor) Freeze(opts *bind.TransactOpts, _value *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "freeze", _value)
}

// Freeze is a paid mutator transaction binding the contract method 0xd7a78db8.
//
// Solidity: function freeze(uint256 _value) returns(bool success)
func (_Token *TokenSession) Freeze(_value *big.Int) (*types.Transaction, error) {
	return _Token.Contract.Freeze(&_Token.TransactOpts, _value)
}

// Freeze is a paid mutator transaction binding the contract method 0xd7a78db8.
//
// Solidity: function freeze(uint256 _value) returns(bool success)
func (_Token *TokenTransactorSession) Freeze(_value *big.Int) (*types.Transaction, error) {
	return _Token.Contract.Freeze(&_Token.TransactOpts, _value)
}
...
func (_Token *TokenTransactor) Unfreeze(opts *bind.TransactOpts, _value *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "unfreeze", _value)
}

// Unfreeze is a paid mutator transaction binding the contract method 0x6623fc46.
//
// Solidity: function unfreeze(uint256 _value) returns(bool success)
func (_Token *TokenSession) Unfreeze(_value *big.Int) (*types.Transaction, error) {
	return _Token.Contract.Unfreeze(&_Token.TransactOpts, _value)
}

// Unfreeze is a paid mutator transaction binding the contract method 0x6623fc46.
//
// Solidity: function unfreeze(uint256 _value) returns(bool success)
func (_Token *TokenTransactorSession) Unfreeze(_value *big.Int) (*types.Transaction, error) {
	return _Token.Contract.Unfreeze(&_Token.TransactOpts, _value)
}
...
// TokenUnfreezeIterator is returned from FilterUnfreeze and is used to iterate over the raw logs and unpacked data for Unfreeze events raised by the Token contract.
type TokenUnfreezeIterator struct {
	Event *TokenUnfreeze // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenUnfreezeIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenUnfreezeIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenUnfreezeIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenUnfreeze represents a Unfreeze event raised by the Token contract.
type TokenUnfreeze struct {
	From  common.Address
	Value *big.Int
	Raw   types.Log // Blockchain specific contextual infos
}
...
func (_Token *TokenFilterer) FilterUnfreeze(opts *bind.FilterOpts, from []common.Address) (*TokenUnfreezeIterator, error) {
	...
	logs, sub, err := _Token.contract.FilterLogs(opts, "Unfreeze", fromRule)
	if err != nil {
		return nil, err
	}
	return &TokenUnfreezeIterator{contract: _Token.contract, event: "Unfreeze", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Unfreeze(address indexed from, uint256 value)
func (_Token *TokenFilterer) WatchUnfreeze(opts *bind.WatchOpts, sink chan<- *TokenUnfreeze, from []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Token.contract.WatchLogs(opts, "Unfreeze", fromRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenUnfreeze)
				if err := _Token.contract.UnpackLog(event, "Unfreeze", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Unfreeze(address indexed from, uint256 value)
func (_Token *TokenFilterer) ParseUnfreeze(log types.Log) (*TokenUnfreeze, error) {
	event := new(TokenUnfreeze)
	if err := _Token.contract.UnpackLog(event, "Unfreeze", log); err != nil {
		return nil, err
	}
